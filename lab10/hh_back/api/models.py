...
# company10 = Company(name="Enterprises", description="A company", city="d",address="Oak St")
...
# vacancy11 = Vacancy(name="Manager", description="Create and execute  sales", salary=20000.0, company=company10)
